        ...
        <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          {education.map((edu, idx) => (
            <motion.a 
              ...
              className="group relative glassCard rounded-[2.5rem] p-6 sm:p-8 md:p-12 flex flex-col items-center text-center shadow-sm hover:shadow-xl transition-all duration-500"
            >
              {/* Logo Container */}
